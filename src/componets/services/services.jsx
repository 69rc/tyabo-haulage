            ...
            <Container className="py-5">
                ...
                <Row className="g-4">
                    ...
                    <Col md={6} lg={4} className="wow fadeInUp" data-wow-delay="0.5s">
                        <Card className="service-item p-4">
                            <CardImg top className="img-fluid" src={services2} alt="Ocean Freight" />
                            <CardBody>
                    ...
                    <Col md={6} lg={4} className="wow fadeInUp" data-wow-delay="0.7s">
                        <Card className="service-item p-4">
                            <CardImg top className="img-fluid" src={services3} alt="Road Freight" />
                            <CardBody>
                    ...
                    <Col md={6} lg={4} className="wow fadeInUp" data-wow-delay="0.3s">
                        <Card className="service-item p-4">
                            <CardImg top className="img-fluid" src={services4} alt="Train Freight" />
                            <CardBody>
                    ...
                    <Col md={6} lg={4} className="wow fadeInUp" data-wow-delay="0.5s">
                        <Card className="service-item p-4">
                            <CardImg top className="img-fluid" src={services5} alt="Customs Clearance" />
                            <CardBody>
                    ...
                    <Col md={6} lg={4} className="wow fadeInUp" data-wow-delay="0.7s">
                        <Card className="service-item p-4">
                            <CardImg top className="img-fluid" src={services6} alt="Warehouse Solutions" />
                            <CardBody>
